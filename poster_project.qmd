...
*Poster project with Martin Tran for STAT 405 (Advanced Data Computing), built in R. [Open the full poster →](S,-R,-and-Data-Science.html){target="_blank"}*
...
[![Preview of the S-to-R poster](poster_preview.png){width=100%}](S,-R,-and-Data-Science.html)

*Click the poster to open the full-resolution version in a new tab.*
